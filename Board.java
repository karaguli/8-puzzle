...
public class Board {
    ...
    //Converts the board state into a 2D array for easy comparison with the goal state.
    ...
    //Creates a deep copy of the board, useful for exploring different move sequences without altering the original board.
    public Board clone() {
    ...
    /*Overridden these methods to allow comparison of Board objects based on their tile arrangements. 
	This is important for tracking visited states in the A* algorithm.*/
